...
$(deps_net/ethernet/eth.o):
#SYMVER eth_header 0xb5407e74
#SYMVER eth_get_headlen 0x1f44b7b1
#SYMVER eth_type_trans 0x76438e21
#SYMVER eth_header_parse 0x23452bf3
#SYMVER eth_header_cache 0xcb00b6e3
#SYMVER eth_header_cache_update 0x1cbc4ccd
#SYMVER eth_header_parse_protocol 0xa9b875dd
#SYMVER eth_prepare_mac_addr_change 0xba2f8cf4
#SYMVER eth_commit_mac_addr_change 0x595c6ef8
#SYMVER eth_mac_addr 0x21d07639
#SYMVER eth_validate_addr 0x7620db29
#SYMVER ether_setup 0x6f660dde
#SYMVER alloc_etherdev_mqs 0x2cadc655
#SYMVER sysfs_format_mac 0x81533963
#SYMVER eth_gro_receive 0x22c2c725
#SYMVER eth_gro_complete 0xdaf5a457
#SYMVER eth_platform_get_mac_address 0xfda0c1b3
#SYMVER platform_get_ethdev_address 0xc495dd15
#SYMVER fwnode_get_mac_address 0xf5103de4
#SYMVER device_get_mac_address 0x008dfe0a
#SYMVER device_get_ethdev_address 0x4ecff6ec
