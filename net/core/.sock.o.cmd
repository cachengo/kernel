...
$(deps_net/core/sock.o):
#SYMVER sk_ns_capable 0xff0ce00a
#SYMVER sk_capable 0x0536e1dd
#SYMVER sk_net_capable 0x46435d09
#SYMVER sysctl_wmem_max 0xfac8865f
#SYMVER sysctl_rmem_max 0xb05fc310
#SYMVER memalloc_socks_key 0x77ecf68d
#SYMVER sk_set_memalloc 0x2fe42bf2
#SYMVER sk_clear_memalloc 0x273ab955
#SYMVER __sk_backlog_rcv 0xfff9d5d5
#SYMVER sk_error_report 0x93e9167b
#SYMVER sock_get_timeout 0xedd17b31
#SYMVER sock_copy_user_timeval 0x5bdb7603
#SYMVER __sock_queue_rcv_skb 0x65e22084
#SYMVER sock_queue_rcv_skb_reason 0xac67aa9c
#SYMVER __sk_receive_skb 0x9ec619b1
#SYMVER __sk_dst_check 0x02816238
#SYMVER sk_dst_check 0x5f37d515
#SYMVER sock_bindtoindex 0x6d12feec
#SYMVER sk_mc_loop 0x73ef0816
#SYMVER sock_set_reuseaddr 0x6998e443
#SYMVER sock_set_reuseport 0xa318a0c2
#SYMVER sock_no_linger 0x8639677c
#SYMVER sock_set_priority 0xeaae79bb
#SYMVER sock_set_sndtimeo 0xd6d7eac9
#SYMVER sock_enable_timestamps 0x2ec5a4b3
#SYMVER sock_set_keepalive 0x91e55138
#SYMVER sock_set_rcvbuf 0xa1b63278
#SYMVER sock_set_mark 0x9df5351c
#SYMVER sockopt_lock_sock 0xf7a63b2b
#SYMVER sockopt_release_sock 0xca2fe1b6
#SYMVER sockopt_ns_capable 0x4e5d1ba5
#SYMVER sockopt_capable 0x2a6a5aac
#SYMVER sock_setsockopt 0x973cbafe
#SYMVER sk_alloc 0x4fd19fc5
#SYMVER sk_net_refcnt_upgrade 0x717e9853
#SYMVER sk_free 0x8d104ca3
#SYMVER sk_clone_lock 0x56cd3ac7
#SYMVER sk_free_unlock_clone 0x02a4b03b
#SYMVER sk_setup_caps 0x4bfa31b8
#SYMVER sock_wfree 0x493b00d5
#SYMVER skb_set_owner_w 0xca59f831
#SYMVER skb_orphan_partial 0x961e3fc9
#SYMVER sock_rfree 0xdfa751ac
#SYMVER sock_efree 0x9a312e5c
#SYMVER sock_pfree 0x83ff7136
#SYMVER sock_i_uid 0xdaa6c38f
#SYMVER __sock_i_ino 0xe16a2ee5
#SYMVER sock_i_ino 0x70cee8c9
#SYMVER sock_wmalloc 0xf32c3602
#SYMVER sock_kmalloc 0x64dbebbd
#SYMVER sock_kfree_s 0xfa810922
#SYMVER sock_kzfree_s 0xf1412edb
#SYMVER sock_alloc_send_pskb 0xf913c5ec
#SYMVER __sock_cmsg_send 0x585879e5
#SYMVER sock_cmsg_send 0xb73be51a
#SYMVER skb_page_frag_refill 0xe7c99854
#SYMVER sk_page_frag_refill 0xbd0e3021
#SYMVER __sk_flush_backlog 0xb1760078
#SYMVER sk_wait_data 0x4473a70e
#SYMVER __sk_mem_schedule 0xf091aea0
#SYMVER __sk_mem_reclaim 0xd12405bd
#SYMVER sk_set_peek_off 0x612bcc14
#SYMVER sock_no_bind 0x006bbf3d
#SYMVER sock_no_connect 0x97dac373
#SYMVER sock_no_socketpair 0x768b6d6b
#SYMVER sock_no_accept 0x381cc563
#SYMVER sock_no_getname 0xaa0115a2
#SYMVER sock_no_ioctl 0x5788a837
#SYMVER sock_no_listen 0x6458c176
#SYMVER sock_no_shutdown 0x4a11ba63
#SYMVER sock_no_sendmsg 0x53e96ea4
#SYMVER sock_no_sendmsg_locked 0xc045dcb3
#SYMVER sock_no_recvmsg 0xf49cbc41
#SYMVER sock_no_mmap 0x00f21234
#SYMVER sk_send_sigurg 0x17e7137c
#SYMVER sk_reset_timer 0x8704f18f
#SYMVER sk_stop_timer 0x4cb73e41
#SYMVER sk_stop_timer_sync 0xdaa4ba86
#SYMVER sock_init_data_uid 0xf4d77925
#SYMVER sock_init_data 0x93a0c007
#SYMVER lock_sock_nested 0x94baa26f
#SYMVER release_sock 0x51ced833
#SYMVER __lock_sock_fast 0xac1d48c3
#SYMVER sock_gettstamp 0x1ba0ddd3
#SYMVER sock_recv_errqueue 0xf008a33b
#SYMVER sock_common_getsockopt 0xb84c010c
#SYMVER sock_common_recvmsg 0xe04dbf8b
#SYMVER sock_common_setsockopt 0xa53fda9d
#SYMVER sk_common_release 0x8dbc5df4
#SYMVER sock_prot_inuse_get 0x5d26127d
#SYMVER sock_inuse_get 0x7272d6d2
#SYMVER proto_register 0xb4f86a52
#SYMVER proto_unregister 0xce55f03f
#SYMVER sock_load_diag_module 0xf665f74f
#SYMVER sk_busy_loop_end 0xe590dea3
#SYMVER sock_bind_add 0xe583b546
#SYMVER sock_ioctl_inout 0x0883d983
#SYMVER sk_ioctl 0x5f69674a
