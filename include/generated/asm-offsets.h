...
#define THREAD_CPU_CONTEXT 3088 /* offsetof(struct task_struct, thread.cpu_context) */
...
#define VCPU_CONTEXT 288 /* offsetof(struct kvm_vcpu, arch.ctxt) */
#define VCPU_FAULT_DISR 3496 /* offsetof(struct kvm_vcpu, arch.fault.disr_el1) */
#define VCPU_HCR_EL2 3448 /* offsetof(struct kvm_vcpu, arch.hcr_el2) */
...
#define HOST_CONTEXT_VCPU 3120 /* offsetof(struct kvm_cpu_context, __hyp_running_vcpu) */
