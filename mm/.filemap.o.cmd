...
$(deps_mm/filemap.o):
#SYMVER filemap_check_errors 0x06ccf7fe
#SYMVER filemap_fdatawrite_wbc 0x4760553e
#SYMVER filemap_fdatawrite 0x64d8e4b6
#SYMVER filemap_fdatawrite_range 0x50846a8f
#SYMVER filemap_fdatawrite_range_kick 0x130de749
#SYMVER filemap_flush 0x8fc6e697
#SYMVER filemap_range_has_page 0x595d8f0d
#SYMVER filemap_fdatawait_range 0xb6865aed
#SYMVER filemap_fdatawait_range_keep_errors 0xfb9a4921
#SYMVER file_fdatawait_range 0x6b69e90d
#SYMVER filemap_fdatawait_keep_errors 0x0a1b8f88
#SYMVER filemap_range_has_writeback 0x4a8cf2f1
#SYMVER filemap_write_and_wait_range 0xda44a2b9
#SYMVER __filemap_set_wb_err 0x8f4f5046
#SYMVER file_check_and_advance_wb_err 0x599ce6c8
#SYMVER file_write_and_wait_range 0x29ef74df
#SYMVER replace_page_cache_folio 0xccdc333b
#SYMVER filemap_add_folio 0xdbba620a
#SYMVER filemap_alloc_folio_noprof 0xfdfef469
#SYMVER filemap_invalidate_lock_two 0x21581455
#SYMVER filemap_invalidate_unlock_two 0x2b608c4a
#SYMVER folio_wait_bit 0xb0bb5e16
#SYMVER folio_wait_bit_killable 0x0c4518cc
#SYMVER folio_unlock 0xf41be376
#SYMVER folio_end_read 0x2e7ce535
#SYMVER folio_end_private_2 0xa307778b
#SYMVER folio_wait_private_2 0x55ab7e8b
#SYMVER folio_wait_private_2_killable 0xed309155
#SYMVER folio_end_writeback 0xf8367d93
#SYMVER __folio_lock 0x128fa14b
#SYMVER __folio_lock_killable 0x9a225c92
#SYMVER page_cache_next_miss 0x1d6daa99
#SYMVER page_cache_prev_miss 0x6baf1548
#SYMVER __filemap_get_folio 0x7252438d
#SYMVER filemap_get_folios 0xfcab51bc
#SYMVER filemap_get_folios_contig 0xbfaf1261
#SYMVER filemap_get_folios_tag 0x4f38e055
#SYMVER filemap_read 0xf2083290
#SYMVER kiocb_write_and_wait 0x1a9a88dc
#SYMVER kiocb_invalidate_pages 0x0afa14ba
#SYMVER generic_file_read_iter 0x9a047456
#SYMVER filemap_splice_read 0x63aa7bb9
#SYMVER filemap_fault 0x56a497a6
#SYMVER filemap_map_pages 0x9ddbb757
#SYMVER filemap_page_mkwrite 0x7ec400c0
#SYMVER generic_file_mmap 0x2978603c
#SYMVER generic_file_readonly_mmap 0x06c4978e
#SYMVER read_cache_folio 0x4f472100
#SYMVER mapping_read_folio_gfp 0x46dd5a92
#SYMVER read_cache_page 0x357cf1b9
#SYMVER read_cache_page_gfp 0x6a7f6a17
#SYMVER generic_file_direct_write 0x95e41803
#SYMVER generic_perform_write 0xe391f73b
#SYMVER __generic_file_write_iter 0x156be400
#SYMVER generic_file_write_iter 0xb32d9eaf
#SYMVER filemap_release_folio 0x7fc0cd9f
#SYMVER filemap_invalidate_inode 0xb42f3b7f
