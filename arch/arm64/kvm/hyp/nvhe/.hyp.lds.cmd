savedcmd_arch/arm64/kvm/hyp/nvhe/hyp.lds := gcc -E -Wp,-MMD,arch/arm64/kvm/hyp/nvhe/.hyp.lds.d -nostdinc -I./arch/arm64/include -I./arch/arm64/include/generated -I./include -I./include -I./arch/arm64/include/uapi -I./arch/arm64/include/generated/uapi -I./include/uapi -I./include/generated/uapi -include ./include/linux/compiler-version.h -include ./include/linux/kconfig.h -D__KERNEL__ -mlittle-endian -DCC_USING_PATCHABLE_FUNCTION_ENTRY -DKASAN_SHADOW_SCALE_SHIFT=   -P -Uarm64 -D__ASSEMBLY__ -DLINKER_SCRIPT -o arch/arm64/kvm/hyp/nvhe/hyp.lds arch/arm64/kvm/hyp/nvhe/hyp.lds.S
